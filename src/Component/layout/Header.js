                ...
                <Container maxWidth="lg"   >
                    ...
                    <Box component="div"  display="flex" alignItems="center">
                        ...
                        <Typography component="h1" variant="h5" fontWeight="bold" mr={1} >
                            <Link to="/" style={{textDecoration:"none" , color:"#e5f2fd" }}>
                             وبلاگ بوتو استارت
                            </Link>
                        </Typography>
                    </Box>
                    ...
                    <Typography component="p" variant="h5" fontSize={18} fontWeight={700}>
                            <Link to="/authorsAll" style={{textDecoration:"none"  , color:"#e5f2fd" }}>
                               نویسنده ها
                            </Link>
                        </Typography>
                        <Typography component="p" variant="h5" fontSize={18}  fontWeight={700} mr={5}>
                            <Link to="/blogsAll" style={{textDecoration:"none", color:"#e5f2fd"}}>
                               وبلاگ ها
                            </Link>
                        </Typography>
                    </Box>
